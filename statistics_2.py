...
with open('statistics_2.csv', 'w') as outfile:
  ...
  for date_end in range(1900, 2012):
    ...
    print date_end,":",result_parsed.res_count

    outfile.write ("Wert"+","+str(date_end)+","+str(result_parsed.res_count)+chr(10))
